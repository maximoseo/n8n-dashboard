...
import { AlertOctagon, BarChart3, Boxes, Bot, Copy, Gauge, Globe, LayoutGrid, LayoutTemplate, Link2, Search, Settings, TrendingUp, Workflow } from 'lucide-react'
...
const items = [
  ...
  { id: 'seopacks', label: 'Packs', icon: Boxes },
