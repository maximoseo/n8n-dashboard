...
const navItems = [
  ...
  { id: 'competitors', label: 'Competitors', icon: Target, count: 3 },
  { id: 'rank', label: 'Rank Monitor', icon: TrendingUp, count: 5 },
  { id: 'analytics', label: 'Analytics', icon: BarChart3, count: null },
  { id: 'ai', label: 'AI Generator', icon: Sparkles, count: null },
